...
*/ -->
            <div style="padding-top: 10px;">
                <marquee onMouseOver="this.stop()" onMouseOut="this.start()">Copyright © 2023 Aryav Varshney Devloper. All rights reserved. Unauthorized use or reproduction of the content is prohibited</marquee>
            </div>
