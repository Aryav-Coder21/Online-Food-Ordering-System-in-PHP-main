...
<body class="home">
    ...
    <section class="how-it-works">
        <div class="container">
            ...
            /* The above code is a comment in PHP. It is used to add explanatory notes or documentation within the code. In this case, it is commenting out a closing div tag. */
            </div>
        </div>
    </section>
